...
- The currently implemented event log covers setup, first-turn step progression, drawing, precombat priority passing through the currently supported forced-pass branch, land play, `Plains` mana production, simple creature spell resolution, and minimal combat damage/state-based destruction.
