...
class PullSourcesTests(unittest.TestCase):
    def test_load_active_support_slice_targets_reads_manifest_scope(self) -> None:
        ...
        self.assertEqual(targets[-1].oracle_id, "8973bd99-20f8-4867-90ef-50392147ee1b")
        ...
        self.assertIn("4d62a448-b6a5-43b1-a281-9e9361a5524a", [target.oracle_id for target in targets])
        self.assertIn("9971697b-2acc-4bc2-a44e-074d03a51df7", [target.oracle_id for target in targets])
        self.assertIn("031cd561-d9b1-4a0e-bc38-bc09e80563c3", [target.oracle_id for target in targets])
        ...
        self.assertIn("76da2150-34b9-4483-99df-131e1c5468d5", [target.oracle_id for target in targets])
        self.assertIn("09fe624f-c66a-46e4-a9af-7e3c3ca1a4e3", [target.oracle_id for target in targets])
        self.assertIn("8973bd99-20f8-4867-90ef-50392147ee1b", [target.oracle_id for target in targets])
